...
<table width="780" align="center" CELLSPACING=0
	...
	<tr>
		...
		<table width=80% align="center" cellpadding=0 cellspacing="1"
			...
			<tr>
				<td colspan="4">
				<div class="mytitle">您当前的拍卖物品：</div>
				</td>
			</tr>
			...
			<s:iterator id="item" value="items" status="st">
				<tr class="pt9" height="24"
					<s:if test="#st.odd">style="background-color:#dddddd"</s:if>
	...
	<tr>
		<td><br>
		添加新物品 <s:actionerror /> <s:form action="proAddItem.action">
			...
			<s:select
				list="#{'1':'一天','2':'二天','3':'三天','4':'四天','5':'五天','6':'一个星期','7':'一个月','8':'一年'}"
				label="有效时间" />
			<s:select list="kinds" label="物品种类" name="kind" listKey="id"
				listValue="kindName" />
